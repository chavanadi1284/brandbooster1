...
const services = [
  ...
  { title: 'Website Development', icon: FaCode, copy: 'React and Tailwind builds that blend performance, motion, and a refined user experience.' },
...
export default function ServicesPage() {
  ...
  return (
    <div className="container-laptop mx-auto px-4 pt-36 md:px-6 md:pt-40 lg:pt-44">
      ...
      <section className="section-shell mt-14 grid gap-4 md:grid-cols-2 xl:grid-cols-3 lg:mt-16">
        {services.map((service, index) => {
          ...
          return (
            ...
            >
              ...
              <h2 className="mt-8 fluid-card-title font-display uppercase leading-[0.92] tracking-[0.08em] text-navy">{service.title}</h2>
      ...
      <section className="section-shell mt-16 grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start lg:mt-18">
        <div className="rounded-[36px] border border-black/[0.06] bg-[linear-gradient(180deg,#061B3A,#07111f)] p-6 text-white md:p-10">
          <SectionHeading eyebrow="Included in Every Project" title="A design language that stays consistent across the stack." dark />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {['Premium art direction', 'Scroll storytelling', 'Responsive layouts', 'Motion-first details', 'Performance-aware builds', 'Launch-ready polish'].map((item, index) => (
            <motion.div
              key={item}
        ...
        <div className="rounded-[36px] bg-[linear-gradient(135deg,#e8e8e8,#d9d9d9)] px-6 py-12 md:px-10 md:py-16">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-4 fluid-card-title-lg font-display uppercase leading-[0.92] tracking-[0.08em] text-navy">
                Need a custom scope?
              </h2>
            </div>
            <Link to="/contact" className="inline-flex items-center gap-3 rounded-full bg-navy px-7 py-4 font-groove text-xs font-semibold uppercase tracking-[0.3em] text-white">
