    ...
    <div className="container-laptop mx-auto px-4 pt-36 md:px-6 md:pt-40 lg:pt-44">
      <section className="section-shell grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
        <div>
          ...
          <h1 className="mt-4 max-w-4xl fluid-display-lg font-display uppercase leading-[0.92] tracking-[0.08em] text-navy">
      ...
      <section className="section-shell mt-14 grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:mt-16 lg:items-start">
        <motion.form initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} className="rounded-[36px] border border-black/[0.08] bg-[rgba(255,255,255,0.3)] p-6 shadow-[0_24px_70px_rgba(6,27,58,0.08)] backdrop-blur-xl md:p-8">
        ...
        <div className="grid gap-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} className="rounded-[36px] border border-black/[0.06] bg-[linear-gradient(180deg,#061B3A,#07111f)] p-6 text-white md:p-8">
            ...
            <div className="mt-8 rounded-[28px] border border-[rgba(219,219,219,0.2)] bg-[rgba(219,219,219,0.12)] p-5">
              ...
              <div className="mt-4 flex min-h-[180px] items-center justify-center rounded-[22px] border border-dashed border-[rgba(219,219,219,0.2)] bg-[radial-gradient(circle_at_50%_40%,rgba(255,159,10,0.18),transparent_28%),linear-gradient(180deg,rgba(219,219,219,0.12),rgba(219,219,219,0.04))] text-center lg:min-h-[200px]">
                <div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[{ icon: FaInstagram, label: 'Instagram' }, { icon: FaLinkedinIn, label: 'LinkedIn' }, { icon: FaBehance, label: 'Behance' }].map((item, index) => {
